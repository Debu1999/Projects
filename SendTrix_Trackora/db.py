...
'''def init_db():
    ...
    try:
        with conn.cursor() as cursor:
            ...
            # =========================================================
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS user_token_caches (
...
def init_db():
    ...
    try:
        with conn.cursor() as cursor:
            ...
            # =========================================================
            # USERS (must be created first -- other tables reference it)
            # =========================================================
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS users (
                    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            ...
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS settings (
                    ...
                    followup_mode TEXT DEFAULT 'manual',
                    updated_at TIMESTAMPTZ NOT NULL,
                    UNIQUE(user_id, category_name, version)
                )
            """)
            ...
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS category_templates (
                    ...
                    draft_id TEXT NOT NULL,
                    draft_subject TEXT,
                    UNIQUE(user_id, category_name, version, order_number)
                )
            """)
